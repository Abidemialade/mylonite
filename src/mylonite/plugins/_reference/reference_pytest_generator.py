...
class ReferencePytestGenerator(TestGeneratorBase):
    ...
    def emit(self, exploit: ExploitRecord) -> GeneratedTest:
        ...
        # Reference targets replay against the bundled twin (byte-for-byte
        # unchanged); a CUSTOM target re-drives the REAL app via assert_target_resists.
        template = _TEMPLATE if exploit.target_id.startswith("reference:") else _TEMPLATE_CUSTOM
