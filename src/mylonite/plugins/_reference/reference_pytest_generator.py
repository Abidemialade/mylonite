...
class ReferencePytestGenerator(TestGeneratorBase):
    ...
    def emit(self, exploit: ExploitRecord) -> GeneratedTest:
        ...
        # otherwise reference targets replay against the bundled twin (byte-for-byte
        # unchanged) and a CUSTOM target re-drives the REAL app via assert_target_resists.
